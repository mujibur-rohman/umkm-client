...
const Textarea = ({
  ...
  const classnamesInput = classNames(
    "border-[1px] py-1 h-auto resize-none h-18 px-2 transition-all duration-300 rounded w-full focus:shadow focus:border-blue-500 outline-none placeholder:font-light pr-7 box-border hover:border-blue-500 focus:ring-1",
    {
